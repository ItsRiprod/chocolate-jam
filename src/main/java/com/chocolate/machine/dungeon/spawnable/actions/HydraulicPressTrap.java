...
public class HydraulicPressTrap implements Spawnable {
    ...
    public void activate(
        ...
        // TODO: actual hydraulic press entity, placeholder for now
        ...
        if (spawnedRef == null) {
            LOGGER.atWarning().log("Failed to spawn hydraulic press entity");
            return;
        }
        ...
        LOGGER.atInfo().log("Spawned hydraulic press at (%.1f, %.1f, %.1f)",
